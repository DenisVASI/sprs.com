...
<div class="new_order">
    ...
    $user = Session::all();
    if(array_key_exists('logged_user', $user) == true){
      echo '<a href="/new_order" class="button">Оставить заявку на доставку</a>';
    }
    else{
        echo '<a href="/login" class="button">Оставить заявку на доставку</a>';
    }
    ?>
</div>
<div class="check_order">
    <div class="check_form">
        ...
        <form action="/getTrack" method="post">
            {!! csrf_field() !!}
